...
const CreatePlanRequestSchema = z
  .object({
    ...
    price: z.int().min(0).default(0).describe("Price in cents"),
    ...
    alertThreshold: z.int().min(50).max(100).default(90).describe("Alert threshold"),
    position: z.int().min(0).default(0).describe("Display order position"),
